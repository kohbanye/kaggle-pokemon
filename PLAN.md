...
| 2026-07-02 | ラダーA/B | **QD産デッキ2本を同時提出**(greedy操縦; 54255202=qd2_sur, 54255206=qd_step1_best) | greedy+metal 532.8(north star) | — | held-out: 0.720 / 0.753・NashConv: **-0.17** / 0.33 | **PENDING** | 計測中 | held-out推し(qd_step1_best) vs NashConv推し(qd2_sur)の**どちらのローカル指標がラダーを予測するか**の直接対決=§1.3相関の2点。net_run7+metal は 432.2 で COMPLETE 確定(360.3→445.8→432.2)。run7grass=492.0 |
